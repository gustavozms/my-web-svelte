...
<div
	class="fixed inset-0 flex h-screen w-screen items-center justify-center overflow-hidden bg-white"
>
	<canvas class="overflow-hidden bg-white" bind:this={canvas} on:contextmenu|preventDefault
	></canvas>
</div>
